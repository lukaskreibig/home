...
describe("Dropdown", () => {
  ...
  test('Testing Dropdown Time', async () =>  {
    render(<Dropdown handleSelect={undefined} dataValue={'day'} dropdown={'Time'} />);
  ...
  test('Testing Dropdown Country', async () => {
    render(<Dropdown handleSelect={undefined} dataValue={'DE'} dropdown={'Country'} countries={[{
      cities: "Berlin",
      code: "DE",
      name: "Germany",
    }]} />);
